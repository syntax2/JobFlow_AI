...
export default function ResumeBuilderPage() {
    ...
    if (resumeId) {
      ...
      const loadExisting = () => {
        ...
        if (existingResume) {
          ...
          router.replace('/resumes/builder'); 
          setIsLoadingExisting(false);
        }
      };
      ...
      if(loadingResumes) {
        const checkInterval = setInterval(() => {
          const currentContext = useResume(); 
  ...
  }, [searchParams, getResumeById, loadingResumes, router, toast, useResume]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <Button variant="ghost" onClick={() => router.push('/resumes')} className="text-sm shrink-0">
